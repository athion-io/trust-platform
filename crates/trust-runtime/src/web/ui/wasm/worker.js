import init, { WasmAnalysisEngine } from "/ide/wasm/trust_wasm_analysis.js";
...
function execute(method, params) {
  switch (method) {
    ...
    case "definition":
      return parseJson(engine.definitionJson(JSON.stringify(params)));
    case "documentHighlight":
      return parseJson(engine.documentHighlightJson(JSON.stringify(params)));
    case "rename":
      return parseJson(engine.renameJson(JSON.stringify(params)));
    case "status":
